...
- Add final end-to-end canonical API/CLI repeatability coverage for the processing path, preserving exact issued Stage 11 provenance through the public command boundary without substitution or alternate serialization.
