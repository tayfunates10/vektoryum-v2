...
Material work remains: bind user-facing image/vector quality metrics to concrete canonical comparison fixtures rather than caller-supplied measurements; broaden repeatability across multiple canonical fixtures and formats; and add adversarial end-to-end certification scenarios that combine measured quality, measured performance, certificate issuance and provenance substitution.
